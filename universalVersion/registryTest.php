		...
		if ($userPassword == $confirmPassword && $checker == "true") //checks the user entered their password the same on both tries and filled out all the boxes  
			{
				...
				$sql = "INSERT INTO userDetails SET userLastName='$lastname', userFirstName = '$firstname', userNickname = '$userForumName', userEmail = '$userEmail', userPassword = '$userPassword', reputationPoints = 0";
